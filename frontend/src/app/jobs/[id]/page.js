              ...
              <div className="flex space-x-6">
                ...
                <div className="w-1/2">
                  <div className="text-center mb-4">
                    ...
                    <div className="inline-block border rounded p-4 m-2">
                      <h3 className="text-xl font-bold">{verifiedPercentage && verifiedPercentage?.match_percentage !== null ? `${verifiedPercentage.match_percentage}% Verified Data` : 'Calculating Verified Data...'}</h3>
                    </div>
                    <div className="inline-block border rounded p-4 m-2">
                      <h3 className="text-xl font-bold">{jobCompatibility && jobCompatibility?.relevance_score !== null ? `${jobCompatibility.relevance_score}% Skill Compatibility` : 'Skill Compatibility...'}</h3>
                    </div>
                  </div>
